...
class SecondViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let southamptonRegion = CLCircularRegion(center: southampton, radius: 50 , identifier: "FC_Southampton.jpg")
        ...
        let bournemouthPierRegion = CLCircularRegion(center: bournemouthPier, radius: 50 , identifier: "Bournemouth.jpg")
        ...
        let astonVillaRegion = CLCircularRegion(center: astonVilla, radius: 50 , identifier: "aston.jpg")
        ...
        let chelseaRegion = CLCircularRegion(center: chelsea, radius: 50 , identifier: "chelsea.jpg")
        ...
        let crystalPalaceRegion = CLCircularRegion(center: crystalPalace, radius: 50 , identifier: "Crystal_Palace_FC.jpg")
        ...
        let evertonRegion = CLCircularRegion(center: everton, radius: 50 , identifier: "Everton_FC_logo.jpg")
        ...
        let leciesterRegion = CLCircularRegion(center: leciester, radius: 50 , identifier: "leciester.jpg")
        ...
        let norwichRegion = CLCircularRegion(center: norwich, radius: 50 , identifier: "Norwich_City.jpg")
        ...
        let newcastleRegion = CLCircularRegion(center: newcastle, radius: 50 , identifier: "Newcastle_United_Logo.jpg")
        ...
        let manchesterUnitedRegion = CLCircularRegion(center: manchesterUnited, radius: 50 , identifier: "united.jpg")
        ...
        let manchesterCityRegion = CLCircularRegion(center: manchesterCity, radius: 50 , identifier: "Manchester_City.jpg")
        ...
        let liverpoolRegion = CLCircularRegion(center: liverpool, radius: 50 , identifier: "liverpool.jpg")
        ...
        let tottenhamRegion = CLCircularRegion(center: tottenham, radius: 50 , identifier: "spurs.jpg")
        ...
        let stokeCityRegion = CLCircularRegion(center: stokeCity, radius: 50 , identifier: "Stoke_City_FC.jpg")
        ...
        let swanseaRegion = CLCircularRegion(center: swansea, radius: 50 , identifier: "Swansea_City_AFC_logo.jpg")
        ...
        let westBromRegion = CLCircularRegion(center: westBrom, radius: 50 , identifier: "West_Bromwich_Albion.jpg")
        ...
        let watfordRegion = CLCircularRegion(center: watford, radius: 50 , identifier: "watford.jpg")
        ...
        let westHamRegion = CLCircularRegion(center: westHam, radius: 50 , identifier: "West_Ham_United_FC.jpg")
